        ...
        <nav className="w-full bg-white ">
            <div className="relative flex items-center max-w-screen-xl h-16 mx-auto px-4">
                <div className="flex-1 flex items-center gap-8">
                    <Link href="/" className="uppercase tracking-wide text-sm font-semibold hover:text-gray-700">A propos</Link>
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2">
                    <p className="uppercase tracking-wide text-sm font-semibold">Korentin</p>
                </div>
